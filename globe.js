...
// Die Bild-URLs wurden durch Platzhalter ersetzt, damit die Seite funktioniert.
...
const setupScene = async () => {
    ...
    // HIER werden die Platzhalter-URLs für die Texturen verwendet.
    const earthTexture = new THREE.TextureLoader().load('https://placehold.co/2048x1024/0047AB/FFFFFF?text=Earth+Texture',
        undefined,
        undefined,
        (err) => console.error('Fehler beim Laden der Erd-Textur:', err)
    );
    ...
    // HIER wird ein Platzhalter-URL für die Sterne-Textur verwendet.
    const starfieldTexture = new THREE.TextureLoader().load('https://placehold.co/4096x2048/000000/FFFFFF?text=Starfield+Texture',
        undefined,
        undefined,
        (err) => console.error('Fehler beim Laden der Sterne-Textur:', err)
    );
